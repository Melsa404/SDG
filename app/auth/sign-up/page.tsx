      ...
      <div className="w-full max-w-sm">
        <Card className="bg-card/90 backdrop-blur border-secondary/30">
          <CardHeader>
            ...
            <CardDescription>Create your commander account</CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSignUp}>
              <div className="flex flex-col gap-6">
                ...
                <Button type="submit" className="w-full bg-gradient-to-r from-secondary to-accent" disabled={isLoading}>
                  {isLoading ? "Creating account..." : "Sign up"}
                </Button>
              </div>
              <div className="mt-4 text-center text-sm">
                Already have an account?{" "}
                <Link href="/auth/login" className="underline underline-offset-4 text-secondary">
                  Login
                </Link>
              </div>
            </form>
